...
import { BookOpen, User, Tag, CheckCircle2, LogIn, LogOut, Home } from "lucide-react";
      ...
      <header className="border-b border-border/40 sticky top-0 bg-background/80 backdrop-blur-sm z-50">
        <div className="container mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/"
              className="font-serif text-xl font-bold tracking-tight text-primary flex items-center gap-2"
            >
            ...
            {!isLoading &&
              (isAuthenticated ? (
                <div className="flex items-center gap-3">
                  ...
                  <Link
                    href="/posts/new"
                    className="hidden sm:inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-9 px-4 py-2 shadow-sm hover:shadow"
                  >
                    Write
                  </Link>
                  <Button
      ...
      <footer className="border-t border-border/40 py-12 mt-24 bg-muted/20">
        <div className="container mx-auto px-4 md:px-6 text-center text-muted-foreground">
          ...
          <p className="text-sm uppercase tracking-widest">
            &copy; {new Date().getFullYear()} The Journal. Crafted with care.
          </p>
        </div>
      </footer>
    </div>
